	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float2 uv_TextureSample0 = inputMesh.ase_texcoord.xy * _TextureSample0_ST.xy + _TextureSample0_ST.zw;
				float4 tex2DNode16 = tex2Dlod( _TextureSample0, float4( uv_TextureSample0, 0, 0.0) );
				...
				#endif
				float3 vertexValue = ( ( tex2DNode16 * _Float0 ) * float4( inputMesh.normalOS , 0.0 ) ).rgb;
						...
						)
			{
				...
				float4 tex2DNode16 = tex2D( _TextureSample0, uv_TextureSample0 );
				
				surfaceDescription.Albedo = ( _Color0 * tex2DNode16 ).rgb;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				float2 uv_TextureSample0 = inputMesh.uv0.xy * _TextureSample0_ST.xy + _TextureSample0_ST.zw;
				float4 tex2DNode16 = tex2Dlod( _TextureSample0, float4( uv_TextureSample0, 0, 0.0) );
...
/*ASEBEGIN
Version=18935
954;165;1352;862;958.1728;793.2514;1.3;True;False
Node;AmplifyShaderEditor.SamplerNode;16;-734.705,-145.3595;Inherit;True;Property;_TextureSample0;Texture Sample 0;0;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;18;-658.5668,174.7015;Inherit;False;Property;_Float0;Float 0;1;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.NormalVertexDataNode;12;-508.437,475.7932;Inherit;False;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;17;-345.5554,-29.74269;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;19;-284.7127,-537.8632;Inherit;False;Property;_Color0;Color 0;2;0;Create;True;0;0;0;False;0;False;1,0,0,0;1,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;14;-222.6958,87.41351;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;FLOAT3;0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;23;-16.65117,-342.7144;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
WireConnection;1;11;14;0
ASEEND*/
//CHKSM=F759C2DD592AF14AA4D47C23E5AB393F464D4A8F